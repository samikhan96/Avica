...
public class AddMedication extends AppCompatActivity {
    ...
    public void addPHR() {
        AppUtils.showProgressDialog(AddMedication.this);
        ...
        try {
            ...
            jsonObject.put("type", "MEDICATION_HISTORY");
        } catch (JSONException e) {
            e.printStackTrace();
        }

        AppServices.AddPHR(AddMedication.class.getSimpleName(), jsonObject, new ServiceListener<String, String>() {
            @Override
            public void success(String success) {
                AppUtils.dismisProgressDialog(AddMedication.this);
                AddPHRDialog cdd = new AddPHRDialog(AddMedication.this);
