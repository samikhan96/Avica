...
public class AddDiagnosis extends AppCompatActivity {
    ...
    public void addPHR() {
        AppUtils.showProgressDialog(AddDiagnosis.this);
        ...
        try {
            ...
            jsonObject.put("type", "DIAGNOSIS");
        } catch (JSONException e) {
            e.printStackTrace();
        }

        AppServices.AddPHR(AddDiagnosis.class.getSimpleName(), jsonObject, new ServiceListener<String, String>() {
            @Override
            public void success(String success) {
                AppUtils.dismisProgressDialog(AddDiagnosis.this);
                AddPHRDialog cdd = new AddPHRDialog(AddDiagnosis.this);
