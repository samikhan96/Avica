...
public class AddFamilyHistory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_family_history);
    ...
    public void addPHR() {
        AppUtils.showProgressDialog(AddFamilyHistory.this);
        ...
        try {
            ...
            jsonObject.put("type", "FAMILY_HISTORY");
        } catch (JSONException e) {
            e.printStackTrace();
        }

        AppServices.AddPHR(AddFamilyHistory.class.getSimpleName(), jsonObject, new ServiceListener<String, String>() {
            @Override
            public void success(String success) {
                AppUtils.dismisProgressDialog(AddFamilyHistory.this);
                AddPHRDialog cdd = new AddPHRDialog(AddFamilyHistory.this);
