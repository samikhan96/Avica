...
public class AddSurgicalProcedure extends AppCompatActivity {
    ...
    public void addPHR() {
        AppUtils.showProgressDialog(AddSurgicalProcedure.this);
        ...
        try {
            ...
            jsonObject.put("type", "SURGICAL_HISTORY");
        } catch (JSONException e) {
            e.printStackTrace();
        }

        AppServices.AddPHR(AddSurgicalProcedure.class.getSimpleName(), jsonObject, new ServiceListener<String, String>() {
            @Override
            public void success(String success) {
                AppUtils.dismisProgressDialog(AddSurgicalProcedure.this);
                AddPHRDialog cdd = new AddPHRDialog(AddSurgicalProcedure.this);
