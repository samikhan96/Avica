...
public class RippleBackground extends RelativeLayout {
  ...
  private void init(final Context context, final AttributeSet attrs) {
    ...
    final TypedArray typedArray = context
        .obtainStyledAttributes(attrs, R.styleable.RippleBackground);
    ...
    rippleDurationTime = typedArray
        .getInt(R.styleable.RippleBackground_rb_duration, DEFAULT_DURATION_TIME);
    rippleAmount = typedArray
        .getInt(R.styleable.RippleBackground_rb_rippleAmount, DEFAULT_RIPPLE_COUNT);
    ...
    for (int i = 0; i < rippleAmount; i++) {
      ...
      final ObjectAnimator scaleXAnimator = ObjectAnimator
          .ofFloat(rippleView, "ScaleX", 1.0f, rippleScale);
      ...
      final ObjectAnimator scaleYAnimator = ObjectAnimator
          .ofFloat(rippleView, "ScaleY", 1.0f, rippleScale);
